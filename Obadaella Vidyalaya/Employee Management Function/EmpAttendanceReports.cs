...
namespace Obadaella_Vidyalaya
{
    public partial class EmpAttendanceReports : Form
    {
        ...
        //private void txtSearchCREMPAttendance_TextChanged(object sender, EventArgs e)
        //{
        //    using (Obadaella_VidyalayaEntities db = new Obadaella_VidyalayaEntities())
        //    {
        //        if (String.IsNullOrEmpty(txtSearchCREMPAttendance.Text))
        //        {
        //            dgvEmployeeAttendanceCR.DataSource = null;
        //        }
